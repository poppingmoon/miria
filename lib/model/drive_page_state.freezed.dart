...
/// @nodoc
abstract class _$$_DrivePageStateCopyWith<$Res>
    implements $DrivePageStateCopyWith<$Res> {
  factory _$$_DrivePageStateCopyWith(
          _$_DrivePageState value, $Res Function(_$_DrivePageState) then) =
      __$$_DrivePageStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({List<DriveFolder> breadcrumbs, List<DriveFile> selectedFiles});
}
...
/// @nodoc
class __$$_DrivePageStateCopyWithImpl<$Res>
    extends _$DrivePageStateCopyWithImpl<$Res, _$_DrivePageState>
    implements _$$_DrivePageStateCopyWith<$Res> {
  __$$_DrivePageStateCopyWithImpl(
      _$_DrivePageState _value, $Res Function(_$_DrivePageState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DrivePageState(
      breadcrumbs: null == breadcrumbs
          ? _value._breadcrumbs
          : breadcrumbs // ignore: cast_nullable_to_non_nullable
              as List<DriveFolder>,
...
class _$_DrivePageState implements _DrivePageState {
  const _$_DrivePageState(
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DrivePageStateCopyWith<_$_DrivePageState> get copyWith =>
      __$$_DrivePageStateCopyWithImpl<_$_DrivePageState>(this, _$identity);
}

abstract class _DrivePageState implements DrivePageState {
  const factory _DrivePageState(
      {final List<DriveFolder> breadcrumbs,
      final List<DriveFile> selectedFiles}) = _$_DrivePageState;
