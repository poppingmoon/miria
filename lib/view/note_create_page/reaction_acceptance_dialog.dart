    ...
    return ListView(
      children: [
        ...
        ListTile(
          ...
          title: Text(S.of(context).nonSensitiveOnlyForLocalLikeOnlyForRemote),
        ),
      ],
    );
  }
