    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              S.of(context).manageSettingFiles,
              style: Theme.of(context).textTheme.titleLarge,
            ),
            Text(S.of(context).manageSettingFilesDescription1),
            Text("・${S.of(context).manageSettingFilesDescription2}"),
            Text("・${S.of(context).manageSettingFilesDescription3}"),
            Text("・${S.of(context).manageSettingFilesDescription4}"),
            Text(
